...
public abstract class AbstractMapC<K,V> implements Map<K,V> {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected AbstractMapC() {
        System.out.println("AbstractMapC");
    }
    ...
    public Collection<V> values() {
        ...
        if (vals == null) {
            vals = new AbstractCollectionC<V>() {
     ...
     * { Entry#hashCode hashCode()} on each element (entry) in the
