 ...
 *
 * <p>A special { #LinkedHashMapC(int,float,boolean) constructor} is
 ...
 * backing map.
 *
 * <p>The {#removeEldestEntry(Map.Entry)} method may be overridden to
 ...
 * <em>fail-fast</em>, and additionally report { Spliterator#ORDERED}.
 *
 ...
 * 
 */
public class LinkedHashMapC<K,V>
    extends HashMapC<K,V>
    implements Map<K,V>
{
    ...
    private void transferLinks(LinkedHashMapC.Entry<K,V> src,
                               LinkedHashMapC.Entry<K,V> dst) {
    ...
    Node<K,V> newNode(int hash, K key, V value, Node<K,V> e) {
        LinkedHashMapC.Entry<K,V> p =
            new LinkedHashMapC.Entry<K,V>(hash, key, value, e);
        linkNodeLast(p);
        return p;
    }
    ...
    Node<K,V> replacementNode(Node<K,V> p, Node<K,V> next) {
        ...
        LinkedHashMapC.Entry<K,V> t =
            new LinkedHashMapC.Entry<K,V>(q.hash, q.key, q.value, next);
        transferLinks(q, t);
        return t;
    }
    ...
    void afterNodeRemoval(Node<K,V> e) { // unlink
        LinkedHashMapC.Entry<K,V> p =
            (LinkedHashMapC.Entry<K,V>)e, b = p.before, a = p.after;
    ...
    void internalWriteEntries(java.io.ObjectOutputStream s) throws IOException {
        for (LinkedHashMapC.Entry<K,V> e = head; e != null; e = e.after) {
            s.writeObject(e.key);
     ...
     */
    public LinkedHashMapC(Map<? extends K, ? extends V> m) {
        super();
        accessOrder = false;
